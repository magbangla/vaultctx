...
func (k *vaultconfig) DeleteContextEntry(deleteName string) error {
...
func (k *vaultconfig) ModifyCurrentContext(name string) error {
...
func (k *vaultconfig) ModifyContextName(old, new string) error {
	contexts, err := k.contextsNode()
	if err != nil {
		return err
	}
