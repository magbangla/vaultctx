...
func (k *vaultconfig) contextsNode() (*yaml.Node, error) {
...
func (k *vaultconfig) contextNode(name string) (*yaml.Node, error) {
...
func (k *vaultconfig) ContextNames() []string {
	contexts := valueOf(k.rootNode, "contexts")
	if contexts == nil {
		return nil
	}
...
func (k *vaultconfig) ContextExists(name string) bool {
